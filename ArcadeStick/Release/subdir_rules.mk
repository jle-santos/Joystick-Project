...
%.obj: ../%.asm $(GEN_OPTS) | $(GEN_FILES)
	...
	"C:/Apps/ti/ccs901/ccs/tools/compiler/ti-cgt-c2000_18.12.1.LTS/bin/cl2000" -v28 -ml -mt -O2 --include_path="D:/Work/Joystick-Project-master/ArcadeStick" --include_path="C:/Apps/ti/bios_6_76_00_08/packages/ti/posix/ccs" --include_path="C:/Apps/ti/ccs901/ccs/tools/compiler/ti-cgt-c2000_18.12.1.LTS/include" --diag_warning=225 --diag_wrap=off --display_error_number --preproc_with_compile --preproc_dependency="$(basename $(<F)).d_raw" $(GEN_OPTS__FLAG) "$<"
