...
/* --> ButtonDetect */
extern xdc_Void ButtonDetect(xdc_UArg);
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/Lemuel/OneDrive/CapStone Group/Romalo (Karen dont look)/Code/ArcadeStick/Debug/configPkg/package/cfg/idle_p28L");
...
ti_sysbios_family_c28_Hwi_Object__ ti_sysbios_family_c28_Hwi_Object__table__V[3] = {
    {/* instance#0 */
        ...
        ((xdc_UArg)(0x0)),  /* arg */
        ((xdc_Void(*)(xdc_UArg))((xdc_Fxn)ButtonDetect)),  /* fxn */
        ((xdc_UArg)0),  /* irp */
        ((void*)0),  /* hookEnv */
    },
    {/* instance#1 */
